<template>
    <div class="container bg-dark text-light p-4 rounded">
      ...
      <!-- Komunikaty o błędzie lub brak wyników -->
  ...
  // Ładowanie większej ilości logów
  function loadMore() {
    currentPage.value += 1;
    fetchLogs(false);
  }
  
  // Pierwsze pobranie logów
  onMounted(() => {
    fetchLogs();
  });
  </script>
  ...
  /* Specyficzne style dla kolumny Content */
  .table td:nth-child(2) {
    white-space: normal;
    word-wrap: break-word;
    overflow-wrap: break-word;
    max-width: 400px; /* Maksymalna szerokość dla kolumny content */
    text-align: left;
  }
