<template>
    <div class="d-flex justify-content-center align-items-center vh-100 vw-100">
      <form @submit.prevent="save" class="p-4 border rounded shadow-sm bg-body-secondary d-flex flex-column justify-content-between">
        <Logo />
        <div class="mb-2">
  ...
  onMounted(() => {
    if (isProfileRoute) {
      ...
      form.value = { ...user }; // Wypełnij formularz danymi przekazanymi w props
    }
  });
  </script>
